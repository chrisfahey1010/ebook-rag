...
from ebook_rag_api.api.routes.ingestion import router as ingestion_router
...
api_router.include_router(ingestion_router, prefix="/api/ingestion", tags=["ingestion"])
